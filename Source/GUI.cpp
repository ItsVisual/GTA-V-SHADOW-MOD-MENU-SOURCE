...
//void YTD()
//{
//	std::string path = "ShadowFolder/";
//	std::string name = "Shadowtextures.ytd";
...
void Menu::Drawing::Title(const char * text, RGBAF rgbaf, VECTOR2 position, VECTOR2_2 size, bool center)
{
	...
	if (Menu::Settings::titleRectTexture == 0) {
		...
		Drawing::Spriter("Shadowtextures", Features::current_header, Settings::menuX, 0.0800f, 0.24f, 0.090f, 0, Settings::titleRect.r, Settings::titleRect.g, Settings::titleRect.b, 255);
	}

	if (Menu::Settings::titleRectTexture == 1) {

		Drawing::Spriter("Shadowtextures", "test1", Settings::menuX, 0.0800f, 0.24f, 0.090f, 0, Menu::Settings::titleRect.r, Menu::Settings::titleRect.g, Menu::Settings::titleRect.b, Menu::Settings::titleRect.a);
	}

	if (Menu::Settings::titleRectTexture == 2) {

		Drawing::Spriter("Shadowtextures", "test2", Settings::menuX, 0.0800f, 0.24f, 0.090f, 0, Menu::Settings::titleRect.r, Menu::Settings::titleRect.g, Menu::Settings::titleRect.b, Menu::Settings::titleRect.a);
	}

	if (Menu::Settings::titleRectTexture == 3) {

		Drawing::Spriter("Shadowtextures", "test3", Settings::menuX, 0.0800f, 0.24f, 0.090f, 0, Menu::Settings::titleRect.r, Menu::Settings::titleRect.g, Menu::Settings::titleRect.b, Menu::Settings::titleRect.a);
	}

	if (Menu::Settings::titleRectTexture == 4) {

		Drawing::Spriter("Shadowtextures", "test4", Settings::menuX, 0.0800f, 0.24f, 0.090f, 0, Menu::Settings::titleRect.r, Menu::Settings::titleRect.g, Menu::Settings::titleRect.b, Menu::Settings::titleRect.a);
	}

	if (Menu::Settings::titleRectTexture == 5) {

		Drawing::Spriter("Shadowtextures", "test5", Settings::menuX, 0.0800f, 0.24f, 0.090f, 0, Menu::Settings::titleRect.r, Menu::Settings::titleRect.g, Menu::Settings::titleRect.b, Menu::Settings::titleRect.a);
	}
	...
	//Drawing::Spriter("Shadowtextures", "back", Settings::menuX, 0.1900f, 0.24f, 0.090f, 0, Menu::Settings::titleRect.r, Menu::Settings::titleRect.g, Menu::Settings::titleRect.b, Menu::Settings::titleRect.a);
...
bool Menu::Toggle(const char * option, bool & b00l)
{
	...
	{
		if (Settings::currentOption <= Settings::maxVisOptions && Settings::optionCount <= Settings::maxVisOptions)
			Drawing::Spriter("Shadowtextures", b00l ? "On" : "Off", Settings::menuX + 0.105f, (Settings::optionCount * 0.035f + 0.141f), 0.02f, 0.03f, 0, 255, 255, 255, 200);
		else if (Settings::optionCount > Settings::currentOption - Settings::maxVisOptions && Settings::optionCount <= Settings::currentOption)
			Drawing::Spriter("Shadowtextures", b00l ? "On" : "Off", Settings::menuX + 0.105f, ((Settings::optionCount - (Settings::currentOption - 16)) * 0.035f + 0.141f), 0.02f, 0.03f, 0, 255, 255, 255, 200);
	}
	else
	{
		if (Settings::currentOption <= Settings::maxVisOptions && Settings::optionCount <= Settings::maxVisOptions)
...
void Menu::End(const char * title)
{
    ...
    if (opcount >= 16) {
		...
		//Drawing::Spriter("Shadowtextures", "end", Settings::menuX, 17 *0.035f + 0.1415f, 0.24f, 0.035f, 180, Settings::Endrectloll.r, Settings::Endrectloll.g, Settings::Endrectloll.b, Settings::Endrectloll.a);
        ...
        Drawing::Spriter("Shadowtextures", "favicon", Settings::menuX, ((16 + 1) * 0.035f + 0.140f), 0.020f, 0.035f, 180, Settings::linego.r, Settings::linego.g, Settings::linego.b, Settings::linego.a);
		...
		//Drawing::Spriter("Shadowtextures", "end", Settings::menuX, (Settings::optionCount + 1) * 0.035f + 0.1415f, 0.24f, 0.035f, 180, Settings::Endrectloll.r, Settings::Endrectloll.g, Settings::Endrectloll.b, Settings::Endrectloll.a);
		Drawing::Rect(Settings::line, { Settings::menuX, (Settings::optionCount + 1) * 0.035f + 0.1235f }, { 0.24f, 0.002f });


        Drawing::Spriter("Shadowtextures", "favicon", Settings::menuX, ((Settings::optionCount + 1) * 0.035f + 0.140f), 0.020f, 0.035f, 180, Settings::linego.r, Settings::linego.g, Settings::linego.b, Settings::linego.a);
...
void Menu::AddSmallTitle(char* text)
{
	if (Menu::Settings::menuX < 0.78f)
	{
		...
		Drawing::Spriter("Shadowtextures", "Playerinfo", Settings::menuX + 0.200f, 0.1175f - 0.019f, 0.115f, 0.045f, 180, Menu::Settings::titleRect.r, Menu::Settings::titleRect.g, Menu::Settings::titleRect.b, Menu::Settings::titleRect.a);
	}
	else
	{
		Drawing::Text(text, Settings::titleText2, { Settings::menuX + 0.200f, 0.090f }, { 0.425f, 0.425f }, true);
...
void Menu::PlayerInfoTitle(char* text)
{
	...
	Drawing::Spriter("Shadowtextures", "playerinfo", Settings::menuX + 0.230f, 0.1250f, 0.165f, 0.045f, 180, Settings::line.r, Settings::line.g, Settings::line.b, Settings::line.a);
...
void Menu::PlayerInfoLine(char* text, short line)
{
	if (line == 1) {
		...
		Drawing::Spriter("Shadowtextures", "playerinfo", Settings::menuX + 0.1385f, 0.2520f, 0.019f, 0.085f, 180, Settings::line.r, Settings::line.g, Settings::line.b, Settings::line.a);
