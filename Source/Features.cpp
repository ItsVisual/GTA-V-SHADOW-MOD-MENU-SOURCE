...
void Features::paranormal(bool toggle)
{
	if (GetAsyncKeyState(VK_NUMPAD9))
	{
		...
		UI::_SET_NOTIFICATION_MESSAGE_CLAN_TAG_2("CHAR_SOCIAL_CLUB", "CHAR_SOCIAL_CLUB", 1, 8, "~w~Shadow", "~w~Prime", 1, "UnlockAll", 9, 0);
...
void Features::DepositToBank()
{
	...
	UI::_SET_NOTIFICATION_MESSAGE_CLAN_TAG_2("Textures", "CHAR_GUARD", 1, 8, "Shadow", "Recovery", 1, "", 9, 0);
	UI::_DRAW_NOTIFICATION(FALSE, FALSE);
}
...
void Features::maxvehicle()
{
	...
	VEHICLE::SET_VEHICLE_NUMBER_PLATE_TEXT(vehicle, "Shadow");
}
